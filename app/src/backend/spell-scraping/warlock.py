...
url = "http://dnd5e.wikidot.com/spells:warlock"
...
warlockSpell_df = pd.DataFrame(warlockSpell, columns=title, index=None)
    
engine = create_engine(f'mysql+pymysql://{user}:{password}@{host}/{db}')

warlockSpell_df.to_sql(name='warlockSpell', con=engine, if_exists='replace', index=False)
